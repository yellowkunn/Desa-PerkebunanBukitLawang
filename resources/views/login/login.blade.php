    ...
    <div class="flex h-full w-full">
        <div class="hidden lg:block lg:w-2/3 bg-cover" style="background-image: url('{{ asset('images/bg1.jpg') }}');">
            <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                <div>
                    <h2 class="text-4xl font-bold text-white">Desa Perkebunan Bukit Lawang</h2>
                    <p class="max-w-xl mt-3 text-gray-300">
                        Masuk sebagai admin untuk dapat melakukan perubahan tampilan website Desa Perkebunan Bukit Lawang
                    </p>
                </div>
            </div>
        </div>
